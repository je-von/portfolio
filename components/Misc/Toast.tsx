...
const Toast = (props) => {
  return (
    <div
      id="toast-success"
      className="fixed inset-0 mx-auto mt-5 mb-4 flex h-fit w-full max-w-[80vw] items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400 sm:max-w-sm"
      role="alert"
    >
